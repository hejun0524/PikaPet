...
|---|---|---|
| **🥊 Darcy's Fight Club** | Fights are a "coming soon" page; the 📖 Skills tab is live (10 skills × 5 levels, leveled by Training Manuals from Noonie's deliveries) (the old ⚔️ Adventure and 🥊 Arena views were retired in the cat-business redesign — coins only, no medieval flavor; git history keeps the prototypes) | Build the fights: wire the 10 skills' combat effects (levels already collectible via Training Manuals), fight cards from the real pet's traits/care, async friend battles via shareable fight codes (the Arena prototype's best idea) |
| **🍳 Noonie's Kitchen** | LIVE: 3h order board, pantry + Organic Market, 190 city recipe scrolls (20% tour drop, Pika sells 2/refresh), 10 paw-bots (2 free, rising unlock prices), 15% book drop per delivery | Balance pass (order rewards vs. job pay); hand-tune generated city-recipe ingredient lists (they're procedurally drawn from per-country pools, so a dessert can currently ask for squid); translate the 190 dish names |
